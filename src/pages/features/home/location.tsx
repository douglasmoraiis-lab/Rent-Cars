...
const location: React.FC = () => {
    ...
    <div className="flex-1 relative -mt-44 justify-center px-64">
        <ul className="flex w-full justify-between items-center text-lg font-medium text-gray-800 bg-white dark:bg-gray-800 dark:text-white p-6 shadow-xl rounded-3xl mb-20">
        <li className="flex items-center ml-8 mr-10 space-x-3 flex-grow px-3">
            <MapPin size={24} className="text-gray-500" />
            <div className="flex flex-col">
            <span className="font-semibold">Location</span>
            <p className="text-sm text-gray-500 dark:text-gray-300">Search your location</p>
            </div>
        </li>
        ...
        <li className="flex items-center space-x-3 flex-grow px-2 border-l border-gray-300">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-300">Tue 15 Feb, 09:00</p>
            </div>
        </li>
        ...
        <li className="flex items-center space-x-3 flex-grow px-2 border-l border-gray-300">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-300">Thu 16 Feb, 11:00</p>
            </div>
        </li>
